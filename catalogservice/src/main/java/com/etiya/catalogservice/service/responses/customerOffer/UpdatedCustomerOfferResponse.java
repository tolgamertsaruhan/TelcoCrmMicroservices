...
public class UpdatedCustomerOfferResponse {
    private UUID id;
...
/*
    ...
    public UpdatedCustomerOfferResponse(UUID id, UUID productOfferId, LocalDateTime expirationDate, CustomerOfferStatuses status) {
        this.id = id;
        this.productOfferId = productOfferId;
        this.expirationDate = expirationDate;
        this.status = status;
    ...
    public UpdatedCustomerOfferResponse() {
    }
}
