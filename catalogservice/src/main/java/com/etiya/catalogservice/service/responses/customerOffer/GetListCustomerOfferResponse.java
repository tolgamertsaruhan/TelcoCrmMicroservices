...
public class GetListCustomerOfferResponse {
    private UUID id;
...
/*
    ...
    public GetListCustomerOfferResponse(UUID id, UUID productOfferId, LocalDateTime expirationDate, CustomerOfferStatuses status) {
        this.id = id;
        this.productOfferId = productOfferId;
        this.expirationDate = expirationDate;
        this.status = status;
    ...
    public GetListCustomerOfferResponse() {
    }
}
