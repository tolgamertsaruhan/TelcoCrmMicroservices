...
public class UpdatedProductSpecificationResponse {
    ...
    public UpdatedProductSpecificationResponse(UUID id, String name, String description, ProductSpecificationLifeCycleStatuses lifecycleStatus, String productType) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.lifecycleStatus = lifecycleStatus;
