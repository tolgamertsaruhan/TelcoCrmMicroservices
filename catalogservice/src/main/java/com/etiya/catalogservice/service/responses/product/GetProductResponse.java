...
public class GetProductResponse {
    ...
    public GetProductResponse(UUID id, String name, String description, BigDecimal price, BigDecimal discountedPrice, UUID catalogId, UUID productOfferId, UUID specificationId) {
        Id = id;
        this.name = name;
        this.description = description;
        this.price = price;
