...
public class GetProductOfferResponse {
    ...
    public GetProductOfferResponse(UUID id, String name, String description, LocalDateTime startDate, LocalDateTime endDate, BigDecimal discountRate, ProductOfferStatuses status, UUID productId) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.startDate = startDate;
    ...
    public GetProductOfferResponse() {
    }
}
