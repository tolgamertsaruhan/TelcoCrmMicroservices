package com.etiya.catalogservice.service.requests.customerOffer;
...
public class UpdateCustomerOfferRequest {
    private UUID id;
...
/*
    ...
    public UpdateCustomerOfferRequest(UUID id, UUID productOfferId, LocalDateTime expirationDate, CustomerOfferStatuses status) {
        this.id = id;
        this.productOfferId = productOfferId;
        this.expirationDate = expirationDate;
        this.status = status;
    ...
    public UpdateCustomerOfferRequest() {
    }
}
