...
public class GetProductSpecCharacteristicResponse {
    private UUID id;
    ...
    public GetProductSpecCharacteristicResponse(UUID id, boolean requiredIs, UUID productSpecificationId, UUID characteristicId) {
        this.id = id;
        this.requiredIs = requiredIs;
        this.productSpecificationId = productSpecificationId;
        this.characteristicId = characteristicId;
    ...
    public GetProductSpecCharacteristicResponse() {
    }
}
