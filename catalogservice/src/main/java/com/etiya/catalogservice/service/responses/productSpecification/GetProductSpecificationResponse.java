...
public class GetProductSpecificationResponse {
    ...
    public GetProductSpecificationResponse(UUID id, String name, String description, ProductSpecificationLifeCycleStatuses lifecycleStatus, String productType) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.lifecycleStatus = lifecycleStatus;
    ...
    public GetProductSpecificationResponse() {
    }
}
