...
public class CreatedBillingAccountResponse {
    ...
    public CreatedBillingAccountResponse(UUID id, BillingAccountType type, String accountName, String accountNumber, BillingAccountStatus status, UUID customerId, UUID addressId) {
        this.id = id;
        this.type = type;
        this.accountName = accountName;
        this.accountNumber = accountNumber;
